...
export function useAgent(agent, onStartRequest, onAddApiTokens, onPauseRequest, onResumeRequest, onCompleteRequest) {
    ...
    const [pendingMaxIterations, setPendingMaxIterations] = useState(null);
    ...
    const sendMessage = useCallback(async (userInput) => {
        ...
        try {
            ...
            agent.setToolCallbacks({
                onThinkingText: (content, reasoning) => {
                ...
                onFinalMessage: (content, reasoning) => {
